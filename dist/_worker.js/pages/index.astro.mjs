...
import { $ as $$ProductCard } from '../chunks/ProductCard_C65whVvK.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": "Home", "description": "Shop at vkrama \u2014 premium products curated for quality. Free shipping on orders over Rs. 5,000." }, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="relative overflow-hidden bg-gradient-to-br from-brand-800 via-brand-900 to-brand-950"> <div class="absolute inset-0 opacity-10"> <div class="absolute -top-40 -right-40 w-96 h-96 bg-white rounded-full blur-3xl"></div> <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-brand-400 rounded-full blur-3xl"></div> </div> <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32"> <div class="max-w-2xl"> <span class="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-sm font-medium text-white/80 ring-1 ring-white/20 mb-6"> <span class="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>
Free shipping on orders over Rs. 5,000
</span> <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-[1.1]">
Discover Quality <br class="hidden sm:block"> <span class="text-brand-300">Premium Products</span> </h1> <p class="mt-4 text-lg md:text-xl text-brand-200 leading-relaxed max-w-xl">
Curated collection of premium products. Quality you can trust, prices you'll love.
</p> <div class="flex flex-wrap gap-4 mt-8"> <a href="/products" class="inline-flex items-center gap-2 bg-accent-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-accent-600 transition-all shadow-lg hover:shadow-xl active:scale-[0.98]">
Shop Now
