...
/* empty css                                     */
import { e as createAstro, f as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, q as Fragment } from '../chunks/astro/server_DUQEdt6X.mjs';
import { $ as $$Base } from '../chunks/Base_CGDZG_k5.mjs';
import { $ as $$ProductCard } from '../chunks/ProductCard_jZHK3VPQ.mjs';
import { g as getDb, p as products, e as eq, d as desc, b as categories } from '../chunks/db_BOPxdIeH.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (env?.DB) {
    ...
    try {
      ...
      }).from(products).where(eq(products.status, "active")).orderBy(desc(products.createdAt)).limit(8).all();
