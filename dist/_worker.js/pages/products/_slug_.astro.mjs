...
/* empty css                                        */
import { e as createAstro, f as createComponent, k as renderComponent, l as renderScript, r as renderTemplate, m as maybeRenderHead, q as Fragment, h as addAttribute } from '../../chunks/astro/server_B3LaWqT_.mjs';
import { j as jsxRuntimeExports, $ as $$Base } from '../../chunks/Base_1ducO0Zx.mjs';
import { a as reactExports } from '../../chunks/_@astro-renderers_Drbtiq9T.mjs';
...
Compare at $${(product.compareAtPriceCents / 100).toFixed(2)} </span>`} </div> <button id="add-to-cart"${addAttribute(product.slug, "data-slug")}${addAttribute(product.name, "data-name")}${addAttribute(product.priceCents, "data-price")}${addAttribute(product.imageUrl || "", "data-image")} class="btn-primary btn-lg w-full mt-8 text-base">
Add to Cart
